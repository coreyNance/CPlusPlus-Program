...
void Pelican::PrintValue() {

	cout << "| " << setw(6) << setfill('0') << GetTrackNumber() << "       | ";
	cout << setw(15) << setfill(' ') << left << GetAnimalName() << "| ";
	cout << setw(15) << setfill(' ') << left << GetAnimalType() << "| ";
	cout << setw(15) << setfill(' ') << left << GetAnimalSubType() << "| ";					// print value function to display class values
	cout << setw(15) << setfill(' ') << left << GetEggs() << "| ";							// to be used inthe theZoo vector
